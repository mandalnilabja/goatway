...
func (h *Repo) Embeddings(w http.ResponseWriter, r *http.Request) {
...
func (h *Repo) logEmbeddingsRequest(requestID, credentialID, model string, result *provider.ProxyResult, startTime time.Time) {
